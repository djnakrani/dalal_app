...
export 'package:dalal_app/constants/string.dart';
export 'package:dalal_app/constants/Images.dart';

// all custom Widget import
export 'package:dalal_app/widget/custom_alert.dart';
export 'package:dalal_app/widget/custom_button.dart';
export 'package:dalal_app/widget/custom_logo.dart';
...
export 'package:dalal_app/screens/login_signup_screens/signup.dart';
